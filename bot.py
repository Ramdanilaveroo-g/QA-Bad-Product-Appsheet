...
#  Paling reliable, tanpa SDK issue
# ════════════════════════════════════════════
def call_gemini(image_bytes: bytes, prompt: str) -> str:
    """Panggil Gemini API via HTTP request langsung."""
...
sku_number = 485802
product_name = Tomat Merah Astro Farm 500gram
mfg_date = 16/05/2026
vendor_id = 5051

Sekarang baca label di foto ini. Return HANYA JSON:
{
  "sku_number": "...",
  "product_name": "...",
  "mfg_date": "DD/MM/YYYY",
...
Kalau tidak terbaca isi "". HANYA JSON saja."""
    ...
    try:
        ...
        if m:
            ...
            # Bersihkan SKU: ambil sebelum titik koma
